function data = json2data(string)
% A function to translate encrypted data coming from TWITTER server
% into a structure data can be manipulated by MATLAB
pos = 1;
len = length(string);
...
if pos <= len
    ...
    function error_pos(msg)
        ...
        if poss(3) == poss(2)
            poss(3:4) = poss(2)+[0 -1];         % ne rien afficher aprs
        end
